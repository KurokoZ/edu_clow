              ...
              <div class="example_alt_pagination">
                <div id="container">
                  <div class="full_width big">
                      <a href="<?php echo U('AutoRefresh/add');?>" class="btn btn-info pull-right" style="margin-bottom:10px;">添加消息</a>
                  </div>
                  <div id="demo">
                    <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                      ...
                      <tbody>
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="gradeC">
                              <td><?php echo ($vo['id']); ?></td>
                              <td><?php echo ($vo['title']); ?></td>
                              <td><?php echo (date("Y-m-d H:i:s",$vo['addtime'])); ?></td>
                              <td><a href="<?php echo U('AutoRefresh/edit');?>?id=<?php echo ($vo['id']); ?>"><i class="icon-edit"></i></a></td>
