...
<div class="login-logo">
	<img src="/admin/Public/images/logo.png" width="147" height="33"> 
</div>
<div class="widget">
                ...
                <fieldset>
                    <div class="form-group no-margin">
                        ...
                        <div class="input-group input-group-lg">
                            ...
                            <input type="text" placeholder="请输入帐号" class="form-control input-lg" name="name" id="email" onkeyup="showMsg()">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group input-group-lg">
                            ...
                            <input type="password" placeholder="请输入密码" class="form-control input-lg" name="password" id="password" onkeyup="showMsg()">
                        </div>
...
<!-- AJAX表单 -->
<script src="/admin/Public/js/ajaxForm.js"></script>
<script src="/admin/Public/js/bootstrap3-validation.js"></script>
</body>
</html>
<script>
	//回车事件
